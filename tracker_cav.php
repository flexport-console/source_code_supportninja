        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="form-head d-flex align-items-center mb-sm-4 mb-3">
                    <div class="mr-auto">
                        <h2 class="text-black font-w600">Tracker CAV</h2>
                            ...
                            <div class="col-xl-3">
                                <form class="distro" action="#" method="post">
                                    <div>
                                        ...
                                        <!-- <input hidden type="text" name="tracker_cav" value="catch_all_validate"> -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <form class="distro" action="#" method="post">
                                            ...
                                            <td>
                                                <div class="custom-control custom-checkbox mb-3 checkbox-danger check-xl">
                                                    <input type="checkbox" class="custom-control-input" value="true"  <?php echo (trim($row['hblr'])=="TRUE") ? "checked": ""; ?> name="hblr" id="HBLR<?php echo $row['cav_id']; ?>">
   ...
   $('.distro').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                } else if (result.trim() == "punched_already") {
